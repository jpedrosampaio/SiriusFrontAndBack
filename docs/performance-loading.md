...
CI imprime PERFORMANCE_DISPOSABLE_MONGO com cinco amostras e mediana de analytics e contexto antes/depois. São medições de fixtures em Mongo descartável, não latência do Atlas/Render em produção. Comparação antiga de analytics acima do limite processa menos dados e é explicitamente marcada truncated.
