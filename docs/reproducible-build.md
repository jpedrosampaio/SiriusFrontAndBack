...
Lint cobre src js/jsx, inclusive regras de hooks. Imports/estados/funções sem consumidores foram retirados. Dois hooks nativos não alcançáveis (use-database.js e use-notifications.js) têm sintaxe TypeScript em .js e estão explicitamente fora do lint web; subsistema nativo ser? tratado em proposta separada, sem remoção silenciosa. Não há import deles a partir de index/App/páginas.
